            ...
            <div style={{ display: 'grid', gridTemplateColumns: '0.8fr 1.2fr 2.0fr', gap: '25px', alignItems: 'start' }}>
              ...
              <div style={{ minHeight: '120px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', height: '22px', fontSize: '0.78em', marginBottom: '2px' }}>
                  <div style={{ minWidth: '130px', fontWeight: 'bold' }}>⚠️ RSI({selectedStock.rsi !== null && selectedStock.rsi !== undefined ? Math.round(selectedStock.rsi) : '-'})</div>
                  <div style={{ marginLeft: '10px' }}>
                    {selectedStock.rsi !== null && selectedStock.rsi !== undefined ? (
                      <>
                ...
                {/* R-SQ (0은 유효한 수치임) */}
                <div style={{ display: 'flex', alignItems: 'center', height: '22px', fontSize: '0.78em', marginBottom: '2px' }}>
                  <div style={{ minWidth: '130px', fontWeight: 'bold' }}>📈 R-SQ({selectedStock.r_square !== null && selectedStock.r_square !== undefined ? selectedStock.r_square.toFixed(2) : '-'})</div>
                  <div style={{ marginLeft: '10px' }}>
                    {selectedStock.r_square !== null && selectedStock.r_square !== undefined ? (
                      <>
                ...
                {/* BB상단 (가격 데이터이므로 0보다 커야 유효) */}
                <div style={{ display: 'flex', alignItems: 'center', height: '22px', fontSize: '0.78em', marginBottom: '2px' }}>
                  <div style={{ minWidth: '130px', fontWeight: 'bold' }}>🚀 BB상단({selectedStock.bb_upper ? selectedStock.bb_upper.toLocaleString() : '-'})</div>
                  <div style={{ marginLeft: '10px' }}>
                    {selectedStock.last_price && selectedStock.bb_upper ? (
                      <>
                ...
                {/* LRL (가격 데이터이므로 0보다 커야 유효) */}
                <div style={{ display: 'flex', alignItems: 'center', height: '22px', fontSize: '0.78em', marginBottom: '2px' }}>
                  <div style={{ minWidth: '130px', fontWeight: 'bold' }}>🎯 LRL({selectedStock.lrl ? selectedStock.lrl.toLocaleString() : '-'})</div>
                  <div style={{ marginLeft: '10px' }}>
                    {selectedStock.last_price && selectedStock.lrl ? (
                      <>
                ...
                {/* 이평선 (가격 데이터이므로 0보다 커야 유효) */}
                <div style={{ display: 'flex', alignItems: 'center', height: '22px', fontSize: '0.78em', marginBottom: '2px' }}>
                  <div style={{ minWidth: '130px', fontWeight: 'bold' }}>📊 이평선({selectedStock.ma_short ? selectedStock.ma_short.toLocaleString() : '-'})</div>
                  <div style={{ marginLeft: '10px' }}>
                    {selectedStock.last_price && selectedStock.ma_short ? (
                      <>
